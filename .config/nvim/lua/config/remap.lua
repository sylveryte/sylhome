...
map("n", "<localleader>od",
  function() vim.cmd([[!xdg-open ~/.cache/nvim/diagram-cache/d2/$(ls ~/.cache/nvim/diagram-cache/d2/ -1t |head -1)]]) end,
  { desc = "Open last rendered d2 diagram" })
