return {
  ...
  opts = {
    ...
    formatters = {
      json = {
        'jq'
    }, -- Make sure you have install jq in your system, e.g: brew install jq
      html = {
  ...
  keys = {
    ...
    { ",tv", "<cmd>HurlVerbose<CR>", desc = "Run Api in verbose mode" },
    { ",tV", "<cmd>HurlVeryVerbose<CR>", desc = "Run Api in very verbose mode" },
    -- Run Hurl request in visual mode
    { ",h", ":HurlRunner<CR>", desc = "Hurl Runner", mode = "v" },
  },
}
